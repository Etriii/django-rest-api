...
from api.views import (
    ...
    user_view_set,
    system_view_set,
    user_systems_view_set,
    student_view_set,
    collection_category_view_set,
)
...
router.register(f"collectioncategory", collection_category_view_set.CollectionCategoryViewSet, basename="collcetioncategory")
